...
export const EmptyDigest = () => {
	return (
		<div id='container' className='flex flex-col items-center py-5'>
			<div
				id='icon'
				className='size-24 rounded-full bg-accent-foreground flex items-center justify-center text-accent dark:text-[#60A5FA]'
			>
				<Digest className='size-9' />
			</div>
